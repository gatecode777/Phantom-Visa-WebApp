    ...
    <div className="w-full bg-[#F8FAFC] text-slate-800 font-sans min-h-screen p-4 sm:p-6 lg:p-8 animate-in fade-in duration-200">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl shadow-xs overflow-hidden mb-6">
                    ...
                    <td className="py-3.5 px-4">
                      {a.documentsStatus === "Complete" ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-amber-700 bg-amber-50 px-2 py-0.5 rounded text-[10px] font-bold border border-amber-200">
                          <AlertTriangle size={11} /> {a.documentsStatus}
                        </span>
                      )}
                    </td>
                    ...
                    <td className="py-3.5 px-4">
                      {a.status === "Ready for Approval" ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-amber-700 bg-amber-50 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold border border-amber-200">
                          <AlertTriangle size={11} /> Doc Pending
                        </span>
                      ) : (
                        <span className="inline-flex items-center gap-1 text-blue-700 bg-blue-50 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold border border-blue-200">
                          <ShieldCheck size={11} /> Under Review
                        </span>
                      )}
                    </td>
                    <td className="py-3.5 px-4 text-center">
        ...
        <div className="bg-slate-50/80 px-4 py-3 border-t border-slate-200 flex items-center justify-between text-xs text-slate-500">
          <div>Showing 1 to 10 of 334 Applications Under Review</div>
            ...
            <div className="p-6 overflow-y-auto flex-1 text-xs space-y-6 [scrollbar-width:thin] [scrollbar-color:#3B82F6_#DBEAFE] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-blue-400 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-blue-100">
              ...
              {modalTab === "Overview" && (
                <div className="space-y-6 animate-in fade-in duration-150">
                  {/* WORKFLOW STEPPER */}
                  <div>
                    <h4 className="text-xs font-extrabold text-slate-900 uppercase tracking-wider font-outfit border-b border-slate-100 pb-2 mb-3">Under Review Lifecycle Stepper</h4>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                      ...
                      <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200">
                        <span className="text-[10px] font-extrabold uppercase text-slate-400 block mb-0.5">Reviewing Officer</span>
              ...
              {(modalTab === "Visa & Travel" || modalTab === "Visa Details") && (
                <div className="space-y-4 animate-in fade-in duration-150">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200"><span className="text-[10px] font-extrabold uppercase text-slate-400 block mb-0.5">Purpose of Visit</span><strong className="text-slate-900 font-bold">{activeModalApp.purposeOfVisit || "Vacation Tour"}</strong></div>
              ...
              {(modalTab === "Payment & Invoice" || modalTab === "Payment Details") && (
                <div className="space-y-4 animate-in fade-in duration-150">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200"><span className="text-[10px] font-extrabold uppercase text-slate-400 block mb-0.5">Payment Date &amp; Time</span><strong className="text-slate-900 font-mono font-bold">{activeModalApp.paymentDate || "01 Jul 2026 10:14 AM"}</strong></div>
              ...
              {modalTab === "Verification Checklist" && (
                <div className="space-y-4 animate-in fade-in duration-150">
                  <h4 className="text-xs font-extrabold text-slate-900 uppercase tracking-wider font-outfit border-b border-slate-100 pb-2">Reviewer Verification Checkpoints</h4>
                  <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2.5">
                    {[
                      { key: "verifyIdentityDocs", label: "Verify Identity Documents & Passport MRZ" },
                      { key: "financialVerification", label: "Financial Solvency & Certified Bank Audit" },
                      { key: "employmentVerification", label: "Employment Verification & Employer Verification Letter" },
                      { key: "travelHistoryVerification", label: "Travel History Verification & Previous Visa Stamps" },
                      { key: "policeBackgroundCheck", label: "Police & Background Check Clearance" },
                      { key: "finalApprovalReview", label: "Final Approval Sign-off" }
                    ].map((item) => {
                      const checked = activeModalApp.reviewChecklist[item.key as keyof UnderReviewRecord["reviewChecklist"]];
                      return (
