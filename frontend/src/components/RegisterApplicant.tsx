...
export default function RegisterApplicant({ onClose, onSuccessSubmit }: RegisterApplicantProps) {
            ...
            const apiCountries: ISOCountry[] = data
              ...
              .map((c: any) => {
                ...
                return {
                  ...
                  name: c.name.common,
                  dialCode,
                  flag: c.flags?.svg || c.flags?.png ? "ðŸŒ" : existing?.flag || "ðŸŒ",
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      {toastConfig && (
        <div
          className={`fixed top-5 right-5 z-[9999] flex items-start gap-3 p-4 rounded-2xl shadow-xl max-w-md border transition-all duration-300 animate-in fade-in slide-in-from-top-4 ${
